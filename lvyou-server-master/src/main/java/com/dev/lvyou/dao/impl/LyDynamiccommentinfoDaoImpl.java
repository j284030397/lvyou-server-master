...
@Repository("LyDynamiccommentinfoDao")
public class LyDynamiccommentinfoDaoImpl extends BaseLocationDaoImpl implements LyDynamiccommentinfoDao {
	 private static final String TABLE_STR = LyDynamiccommentinfo.T_NAME; 
	    private static final String CLASS_STR = LyDynamiccommentinfo.class.getSimpleName();
		...
		public Collection<LyDynamiccommentinfo> queryByField(String fieldName, Object fieldValue)throws DAOException {
	    	StringBuffer hql = new StringBuffer().append("from ").append(CLASS_STR).append(" a where a.")
				 								 .append(fieldName).append("=:fieldValue");
	    	Collection<LyDynamiccommentinfo> resutlList = getHibernateTemplate().findByNamedParam(hql.toString(), "fieldValue" , fieldValue) ;
			return resutlList;
		}
	    ...
	    public Collection<LyDynamiccommentinfo> queryByFields(String[] fieldNames, String[] logicOpers, Object[] fieldValues) throws DAOException {
	    	...
	    	Collection<LyDynamiccommentinfo> resutlList = getHibernateTemplate().findByNamedParam(hql.toString(), fieldNames, fieldValues) ; 
	    	return resutlList;
	    }

		public QueryObject query(QueryObject queryObject) throws DAOException {
			StringBuffer fields = new StringBuffer(64) ;
			fields.append(LyDynamiccommentinfo.C_SID).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_SID)).append(",") ;
			fields.append(LyDynamiccommentinfo.C_DYNAMICID).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_DYNAMICID)).append(",") ;
			fields.append(LyDynamiccommentinfo.C_NOTE).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_NOTE)).append(",") ;
			fields.append(LyDynamiccommentinfo.C_FROMUSER).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_FROMUSER)).append(",") ;
			fields.append(LyDynamiccommentinfo.C_TOUSER).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_TOUSER)).append(",") ;
			fields.append(LyDynamiccommentinfo.C_TYPE).append(" as ").append(underscoreName(LyDynamiccommentinfo.C_TYPE)).append(",") ;
			if(fields.length() > 0){

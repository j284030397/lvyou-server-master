...
<mapper namespace="${packageRoot}.dao.${tableClassName}Dao">

  <resultMap id="${tableName}Map" type="${packageRoot}.domain.${tableClassName}">
  ...
  <select id="listByPage" parameterType="${packageRoot}.domain.${tableClassName}" resultMap="${tableName}Map">
  ...
  <select id="getTotalNum" parameterType="${packageRoot}.domain.${tableClassName}" resultType="java.lang.Integer">
    <![CDATA[ select count(ID) from ${realTableName} where DEL_FLAG='1']]>
    <include refid="${tableName}Where"/> 
  </select>  
     
  <insert id="saveObj" parameterType="${packageRoot}.domain.${tableClassName}">
  	<![CDATA[
  ...
  <update id="updateObj" parameterType="${packageRoot}.domain.${tableClassName}">
	  <![CDATA[

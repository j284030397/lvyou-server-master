...
<head>
<meta charset="utf-8" />
<link type="text/css" href="resources/css/test_fix.css" rel="stylesheet">
...
function getOptions(){
	...
	if($(".noColorOption").hasClass("checked")){
		var J_valueList=$(".noColorOption").find(".J_valueList");
		var selected=J_valueList.find("li.selected");
		selected.each(function(){
			noColorOption+=translate($(this).children("a")[0].innerText)+","
		});
		if(noColorOption!=''){
			noColorOption=noColorOption.substring(0,noColorOption.length-1);
		}
	}
	...
	if($(".scopeOption").hasClass("checked")){
		...
		if($("#lessthan").val()!=null){
			scopeOption=$("#lessthan").val()+",";
			morethan=$("#lessthan").val();
		}
		if($("#morethan").val()!=null){
			scopeOption=$("#morethan").val()+",";
	...
	if($(".inputScopeOption").hasClass("checked")){
		inputScopeOption=$("#inputText").val();
	}
				...
				<div class="sl-wrap multiple">
					...
					<div class="sl-value">
						...
						<div class="sl-v-list inputScopeOption checked" style="border: none;">
							...
							<ul class="J_valueList">
								<li><i> <textarea id="inputTest"></textarea>
								</i></li>

							</ul>
						</div>
						<div class="sl-btns">
							<a class="btn btn-primary J_btnsConfirm" onclick="request();" href="javascript:;">确定</a>
			...
			<div class="J_selectorLine s-line">
				<div class="sl-wrap multiple">
					...
					<div class="sl-value" style="background: #f6f7ff;">
						<div class="sl-v-list noAnimalOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noCodeOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noEndOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noHeadOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noBigOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noColorOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noOddOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noHomeWildOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
						...
						<div class="sl-v-list noInputCodeOption checked" style="border: none;">
							<dl>
								<a><i></i></a>
							</dl>
							<div class="sl-key">
